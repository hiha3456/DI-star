...
srun --partition=GAME --quotatype spot -N 2 --gres=gpu:8 --ntasks-per-node 8 -c 32 --job-name=learner_learner_speed -w SH-IDC1-10-198-34-[142,146] --mpi=pmi2 --async --output=./check-learner-speed-logs/learner_output_check_learner_speed.txt python -m distar.bin.rl_train --type learner --coordinator_ip $2